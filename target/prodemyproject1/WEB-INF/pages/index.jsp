	...
	<section class="wadah">
		<div class="container">
			<div class="sidebar hide">
				<div class="header">
					<div class="list-item">
						<a href="#"> <img src="${contextName}/resources/theme1/aset/book-reader.svg" alt=""
					...
					<div class="main">
						<div class="list-item">
							...
							<img src="${contextName}/resources/theme1/aset/home.svg" alt="" class="icon">
								<span class="desc">Beranda</span>
							</a>
						</div>
						<div class="list-item">
							<a href='<c:url value="/login"></c:url>' > 
							<img src="${contextName}/resources/theme1/aset/book.svg" alt="" class="icon">
								<span class="desc">Koleksi</span>
							</a>
						</div>
						<div class="list-item">
							<a href='<c:url value="/login"></c:url>'> 
							<img src="${contextName}/resources/theme1/aset/signin.svg" alt="" class="icon">
								<span class="desc">Masuk</span>
							</a>
						</div>
					</div>
				</div>
			...
			<div class="main-content">
				...
				<div class="mt-16 mb-10 mx-6 w-auto">
					...
					<div class="mt-16 mb-10 mx-6 w-auto">
						...
						<div class=" border rounded-lg p-20 shadow-lg flex text-center">
							<div class="w-[20%]"></div>
							<div class="w-[30%]">
								<a href="${contextName}/register"> <img src="${contextName}/resources/theme1/aset/web-content-creator-icon.svg"
									alt="" class="ikon">
									<p class="font">Registrasi</p>
								</a>
							</div>
							<div class="w-[30%]">
								<a href="${contextName}/login"> <img src="${contextName}/resources/theme1/aset/buy-book-icon.svg" alt=""
									class="ikon">
